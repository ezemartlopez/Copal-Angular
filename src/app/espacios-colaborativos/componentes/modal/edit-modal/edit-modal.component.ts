...
export class EditModalComponent implements OnInit {
  ...
  getReservasEstado(){
    this.apiService.obtenerReservasEstados(
      data => {
        ...
        console.log("Estados traidos: ",this.opcionesTipoReserva);
  ...
  putReservaEstado(id: number, nuevoEstado: any){
    this.apiService. editarReserva(id,nuevoEstado,
      (response) => {
